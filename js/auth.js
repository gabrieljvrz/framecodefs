...
if (loginForm) {
  loginForm.addEventListener('submit', async function(e) {
    ...
    try {
      const response = await fetch('https://framecodefs.onrender.comkend.onrender.com/api/auth/login', {
        method: 'POST',
        headers: {
...
if (registerForm) {
  registerForm.addEventListener('submit', async function(e) { 
    ...
    try {
      const response = await fetch('https://framecodefs.onrender.comkend.onrender.com/api/auth/register', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
